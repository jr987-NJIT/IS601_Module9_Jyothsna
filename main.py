...
async def add_route(operation: OperationRequest):
    ...
    Add two numbers.
    """
    logger.info(f"Add API called with a={operation.a}, b={operation.b}")
    try:
...
async def subtract_route(operation: OperationRequest):
    ...
    """
    logger.info(f"Subtract API called with a={operation.a}, b={operation.b}")
    try:
...
async def multiply_route(operation: OperationRequest):
    ...
    """
    logger.info(f"Multiply API called with a={operation.a}, b={operation.b}")
    try:
...
async def divide_route(operation: OperationRequest):
    ...
    Divide two numbers.
    """
    logger.info(f"Divide API called with a={operation.a}, b={operation.b}")
    try:
